...
public class PostObjectSample {
    ...
    // 需要上传的本地文件，确保该文件存在
    private String localFilePath = "details01.png";
    // OSS域名，如http://oss1-cn-hangzhou.aliyuncs.com
    private String endpoint = "http://oss-cn-beijing.aliyuncs.com";
    // AccessKey请登录https://ak-console.aliyun.com/#/查看
    private String accessKeyId = "LTAIxTLBSvoL5GKG";
    private String accessKeySecret = "vnZG878CxjnFqTRbUg8tXelnzMiB15";
    // 你之前创建的bucket，确保这个bucket已经创建
    private String bucketName = "lytsoso";
    // 上传文件后的object名称
    private String key = "20180126/details01.png";

    
    private void PostObject() throws Exception {
        // 提交表单的URL为bucket域名
        String urlStr = endpoint.replace("http://", "https://" + bucketName+ ".");
