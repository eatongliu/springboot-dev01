...
public class AppendObjectSample {
    ...
    private static String endpoint = "https://oss1-cn-beijing.aliyuncs.com";
    private static String accessKeyId = "LTAIxTLBSvoL5GKG";
    private static String accessKeySecret = "vnZG878CxjnFqTRbUg8tXelnzMiB15";
    
    private static String bucketName = "lytsoso";
    private static String key = "test001";
    ...
    private static File createTempFile() throws IOException {
        File file = File.createTempFile("oss1-java-sdk-", ".txt");
        file.deleteOnExit();
